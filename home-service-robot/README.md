...
## Installation
1. Refer to [this](https://stackoverflow.com/questions/7106012/download-a-single-folder-or-directory-from-a-github-repo) post, to download the ```home-service-robot``` folder from ```https://github.com/michailtam/robotics-sim-projects/tree/master/home-service-robot```. 
