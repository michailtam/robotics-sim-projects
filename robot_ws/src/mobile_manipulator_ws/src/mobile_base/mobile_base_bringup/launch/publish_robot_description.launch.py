...
def generate_launch_description():
    ...
    pkg_share = FindPackageShare(package='mobile_base_description').find('mobile_base_description')
    ...
    urdf_path = os.path.join(pkg_share,'urdf', 'robot_base.urdf.xacro') # 'robot_base.urdf.xacro'
