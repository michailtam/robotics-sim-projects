...
4. Refer to [this](https://stackoverflow.com/questions/7106012/download-a-single-folder-or-directory-from-a-github-repo) post, to download the ```home-service-robot``` folder from the ```https://github.com/michailtam/robotics-sim-projects.git``` repository.
...
| :--- |
| **Screenshot** |
| <img src="./images/rgt_graph_makred.png" alt="Output of rqt_graph" width="660" height="400" border="0" /></a> |
...
<img src="./images/home_service_op.png" alt="Home Service Operations" width="560" height="400" border="0" /></a>
...
<img src="./images/rviz_output.png" alt="Rviz output" width="560" height="400" border="0" /></a>
...
<img src="./images/2d_slam.png" alt="2D SLAM" width="560" height="400" border="0" /></a>